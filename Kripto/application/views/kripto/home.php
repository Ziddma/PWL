...
<head>
    ...
    <script src="<?php echo base_url('/kripto/assets/'); ?>./js/scroll-reveal.js" defer></script>

    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo base_url('/kripto/assets/'); ?>./assets/favicon.svg" type="image/x-icon" />

    <!-- Styles -->
    <link rel="stylesheet" href="<?php echo base_url('/kripto/assets/'); ?>./scss/main.css" />
    ...
    <div class="main-container">
        ...
        <header class="main-header">
            <div class="header-container">
                ...
                <nav class="main-header-navbar">
                    <img src="<?php echo base_url('/kripto/assets/'); ?>./assets/Logo.svg" alt="CRAPPO logo" class="main-header-navbar__logo" />

                    <ul class="main-header-navbar__nav">
                        <li class="main-header-navbar__nav__item">
                            <a href="#products" class="main-header-navbar__nav__link">Beranda</a>
                        </li>
                        <li class="main-header-navbar__nav__item">
                            <a href="#features" class="main-header-navbar__nav__link">Pasar</a>
                        </li>
                        <li class="main-header-navbar__nav__item">
                ...
                <div class="main-header-content-container">
                    <div class="main-header-content-principal">
                        ...
                        <h1 class="main-header-content-principal__title">
                            Tercepat & <span>aman</span> platform untuk invest
                            <span>crypto anda</span>
                        </h1>
                        <p class="main-header-content-principal__description">
                            Jual beli cryptocurrencies dan telah dipercaya oleh pengguna lebih dari 30 milliar transaksi 
                        </p>
                        <a href="#" class="main-header-content-principal__btn">Coba Sekarang <i
                                class="fas fa-angle-right"></i></a>
                    </div>
                    <img src="<?php echo base_url('/kripto/assets/'); ?>./assets/back element.svg" alt="" class="
        ...
        <main class="main-content">
            ...
            <section class="why-us-wrapper">
                ...
                <div class="why-us-section" id="about">
                    ...
                    <img src="<?php echo base_url('/kripto/assets/'); ?>./assets/why-us-section-assets/why-us-Illustration.svg" alt="" class="
            ...
            <section class="cryptocurrencies-section" id="products">
                ...
                <div class="cryptocurrencies-info-cards">
                    ...
                    <div class="info-card">
                        <img src="<?php echo base_url('/kripto/assets/'); ?>./assets/others/litecoin-icon.svg" alt="" class="info-card__icon" />
            ...
            <section class="features-section" id="features">
                ...
                <article class="invest-smart-article">
                    ...
                    <img src="<?php echo base_url('/kripto/assets/'); ?>./assets/features-section-assets/features-section-invest.svg" alt="Crypto stats" class="invest-smart-article__graphic" />
                </article>
                ...
                <article class="detailed-stats-article">
                    ...
                    <img src="<?php echo base_url('/kripto/assets/'); ?>./assets/features-section-assets/features-section-statistic.svg" alt="Detailed statistics"  class="detailed-stats-article__graphic" />
                </article>
                ...
                <article class="grow-profit-article">
                    ...
                    <img src="<?php echo base_url('/kripto/assets/'); ?>./assets/features-section-assets/features-section-table.svg" alt="Profit graphic" class="grow-profit-article__graphic" />
                </article>
            </section>
        </main>
        ...
        <footer class="main-footer">
            <div class="footer-container">
                <img src="<?php echo base_url('/kripto/assets/'); ?>./assets/Logo.svg" alt="CRAPPO company logo" class="main-footer__logo" />
