...
<?php
    ...
    if( isset($_GET['delete']) ) {
        $delete = $db->delete('table_nya_ganti', "id={$_GET['delete']}");
                                    ...
                                    <table class="jsgrid-table" style="margin-bottom: 20px;">
                                        <thead>
                                            <tr class="jsgrid-header-row" style="height: 55px;">
                                                ...
                                                <th class="jsgrid-header-cell">Gender</th>
                                                <th class="jsgrid-header-cell">Age</th>
                                                <th class="jsgrid-header-cell">Address</th>
                                                <?php if($user['role'] == 1){ ?>
